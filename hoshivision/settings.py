"""
Django settings for hoshivision project.
...
SECRET_KEY = 'django-insecure-c-mshde3gny@308lq4remnsd!+cg=70!#q=-p(e-$7&n&ysm)d'
...
WSGI_APPLICATION = 'hoshivision.wsgi.application'
